  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-md border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        ghost:
          "hover:bg-muted hover:text-accent-foreground aria-expanded:bg-muted aria-expanded:text-accent-foreground",
        destructive:
          "bg-destructive/10 text-destructive hover:bg-destructive/20 focus-visible:border-destructive/40 focus-visible:ring-destructive/20",
        link: "text-primary underline-offset-4 hover:underline",
        brand:
          "rounded-full bg-brand-pink text-white hover:bg-brand-pink/90",
        "brand-outline":
          "rounded-full border-2 border-brand-charcoal bg-white text-brand-charcoal hover:bg-brand-charcoal hover:text-white",
        "brand-dark":
          "rounded-full bg-brand-charcoal text-white hover:bg-brand-charcoal/90",
      },
      size: {
        default:
        ...
        brand:
          "h-11 min-w-[170px] gap-1.5 px-8 text-xs font-bold uppercase tracking-[0.14em]",
        icon: "size-9",
        "icon-xs":
